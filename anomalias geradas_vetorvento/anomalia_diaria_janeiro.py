...
windnetcdf4 = Dataset("C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Anomalias_diarias/Vetor vento (850 e 200 hPa)/era5_clim_january.nc")
windnetcdf4
...
clim_period_V = da_v.sel(valid_time=slice('1991-01-01', '2020-01-31'))
clim_period_U = da_u.sel(valid_time=slice('1991-01-01', '2020-01-31'))
...
anom_daily_V[1038]
anom_daily_U[1038]
anom_desired_V = anom_daily_V.sel(valid_time='2024-01-16')
anom_desired_U = anom_daily_U.sel(valid_time='2024-01-16')
...
magnitude_levels = np.linspace(4,22,10)
...
#ax.set_title('Anomalia de vetor vento em 850 hPa - 16/01/2024')
...
# Barra de cores
colorbar_ticks = np.linspace(4,22,10)
