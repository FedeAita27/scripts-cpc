...
windnetcdf4 = Dataset("C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Vetor vento (850 e 200 hPa)/era5_clim_march.nc")
windnetcdf4
...
clim_period_V = da_v.sel(valid_time=slice('1991-03-01', '2020-03-31')) # Sempre trocar de acordo com o mes
clim_period_U = da_u.sel(valid_time=slice('1991-03-01', '2020-03-31')) # Sempre trocar de acordo com o mes
...
anom_daily_V[1038]
anom_daily_U[1038]
anom_desired_V = anom_daily_V.sel(valid_time='2023-03-06')
anom_desired_U = anom_daily_U.sel(valid_time='2023-03-06')
...
magnitude_levels = np.linspace(4,16,13)
...
ax.set_title('Anomalia de vetor vento em 850 hPa - 06/03/2024 (1991-2020)')
...
# Barra de cores
colorbar_ticks = np.linspace(4,16,7)
