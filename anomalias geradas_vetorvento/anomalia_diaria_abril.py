...
windnetcdf4 = Dataset("C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Anomalias/Vetor vento (850 e 200 hPa)/era5_clim_april.nc")
windnetcdf4
...
clim_period_V = da_v.sel(valid_time=slice('1991-04-01', '2020-04-30')) # Sempre trocar de acordo com o mes
clim_period_U = da_u.sel(valid_time=slice('1991-04-01', '2020-04-30')) # Sempre trocar de acordo com o mes
...
anom_daily_V[1038]
anom_daily_U[1038]
anom_desired_V = anom_daily_V.sel(valid_time='2024-04-30')
anom_desired_U = anom_daily_U.sel(valid_time='2024-04-30')
anom_required_V = anom_desired_V.sel(pressure_level=200)
anom_required_U = anom_desired_U.sel(pressure_level=200)
...
magnitude_levels = np.linspace(10,60,17)


fig, ax = plt.subplots(1, 1, figsize = (16, 8), subplot_kw={'projection': ccrs.Orthographic(-50,-60)})

ax.add_feature(cfeature.BORDERS, linestyle='-', linewidth=1)
ax.add_feature(cfeature.COASTLINE, linewidth=1)
ax.set_title('Anomalia de vetor vento em 200 hPa - 30/04/2024')
...
ax.quiver(lon[::pular], lat[::pular], U_filtrado[::pular, ::pular].values,
          V_filtrado[::pular, ::pular].values,
           transform=ccrs.PlateCarree(), scale=800, color='black',
...
#ax.plot(-51.12, -30.02, marker='^', color='red', markersize=5, alpha=0.7)

# Barra de cores
colorbar_ticks = np.linspace(10,60,9)
