...
windnetcdf4 = Dataset("C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Vetor vento (850 e 200 hPa)/era5_clim_june.nc")
windnetcdf4
...
clim_period_V = da_v.sel(valid_time=slice('1991-06-01', '2020-06-30')) # Sempre trocar de acordo com o mes
clim_period_U = da_u.sel(valid_time=slice('1991-06-01', '2020-06-30')) # Sempre trocar de acordo com o mes
...
anom_desired_V = anom_daily_V.sel(valid_time='2023-06-17')
anom_desired_U = anom_daily_U.sel(valid_time='2023-06-17')
...
magnitude_levels = np.linspace(4,20,16)
...
ax.set_title('Anomalia de vetor vento em 850 hPa - 17/06/2023 (1991-2020)')
...
ax.quiver(lon[::pular], lat[::pular], U_filtrado[::pular, ::pular].values,
          V_filtrado[::pular, ::pular].values,
           ...
           headwidth=2, headlength=3, linewidth=5, alpha=1)
...
#ax.plot(-51.12, -30.02, marker='o', color='red', markersize=10, alpha=0.7)

# Barra de cores
colorbar_ticks = np.linspace(4,20,8)
