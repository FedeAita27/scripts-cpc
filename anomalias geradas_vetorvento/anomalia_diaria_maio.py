...
windnetcdf4 = Dataset("C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Anomalias_diarias/Vetor vento (850 e 200 hPa)/era5_clim_may.nc")
windnetcdf4
...
clim_period_V = da_v.sel(valid_time=slice('1991-05-01', '2020-05-31')) # Sempre trocar de acordo com o mes
clim_period_U = da_u.sel(valid_time=slice('1991-05-01', '2020-05-31')) # Sempre trocar de acordo com o mes
...
anom_desired_V = anom_daily_V.sel(valid_time='2024-05-01')
anom_desired_U = anom_daily_U.sel(valid_time='2024-05-01')
...
# Barra de cores
colorbar_ticks = np.linspace(5,30,7)
