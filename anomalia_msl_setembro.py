...
mslnetcdf4 = ('C:/Users/feder/OneDrive/Documentos/nc/msl_september.nc')
...
anom = results['anom_msl'].sel(valid_time=target_date)
...
cf = ax.contourf(da_msl.longitude, da_msl.latitude, anom,
