...
mslnetnetcdf4 = Dataset('C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Anomalias_diarias/MSL/era5_msl_may.nc')
ds_msl = xr.open_dataset(xr.backends.NetCDF4DataStore(mslnetnetcdf4))
...
clim_period_msl = msl_mb.sel(valid_time=slice('1991-05-01', '2020-05-31')) # Sempre trocar de acordo com o mes
...
anom_desired = anom_daily_msl.sel(valid_time='2024-05-02')
...
magnitude_levels = np.linspace(-35, 35, 13)
...
ax.add_feature(reg)
ax.set_title('Anomaly Sea level Pressure - 02/05/2024', size=12)
...
colorbar_ticks = np.linspace(-35,35,7)
