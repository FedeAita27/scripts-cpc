...
mslnetcdf4 = Dataset('C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Anomalias/MSL/era5_msl_april.nc')
...
clim_period_msl = msl_mb.sel(valid_time=slice('1991-04-01', '2020-04-30')) # Sempre trocar de acordo com o mes
...
anom_desired = anom_daily_msl.sel(valid_time='2024-04-30')
...
magnitude_levels = np.linspace(-25, 25, 13)
...
ax.add_feature(reg)
ax.set_title('Anomaly Sea level Pressure 30/04/2024', size=12)
...
colorbar_ticks = np.linspace(-25,25,7)
