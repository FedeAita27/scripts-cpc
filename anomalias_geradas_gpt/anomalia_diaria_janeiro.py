...
gptnetcdf4 = Dataset('C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Anomalias_diarias/Geopotencial/era5_gpt_january.nc')
...
clim_period_gpt = gpt.sel(valid_time=slice('1991-01-01', '2020-01-31')) # Sempre trocar de acordo com o mes
...
anom_desired = anom_daily_gpt.sel(valid_time='2024-01-16', pressure_level=925)
...
gpt_contour = ax.contourf(lon,lat,anom_desired, cmap='jet',
            levels=np.linspace(-200,200, 11), linewidth=0.8, extend='both', 
...
ax.gridlines(draw_labels=dict(left=True, bottom=True, top=False, right=False),
             ...
             alpha=0.5, linestyle='--', transform = ccrs.PlateCarree())

colorbar_ticks = np.linspace(-200,200,11)
