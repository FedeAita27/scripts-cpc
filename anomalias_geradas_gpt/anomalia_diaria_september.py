...
gptnetcdf4 = Dataset('C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Anomalias_diarias/Geopotencial/era5_gpt_september.nc')
...
clim_period_gpt = gpt.sel(valid_time=slice('1991-09-01', '2020-09-30')) # Sempre trocar de acordo com o mes
...
anom_desired = anom_daily_gpt.sel(valid_time='2023-09-04', pressure_level=200)
...
gpt_contour = ax.contourf(lon,lat,anom_desired, cmap='jet',
            levels=np.linspace(-400, 400, 17), linewidth=0.8, extend='both', transform=ccrs.PlateCarree())
...
colorbar_ticks = np.linspace(-400,400,9)
