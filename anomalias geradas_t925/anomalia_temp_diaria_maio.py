...
tempnetcdf = Dataset('C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Anomalias/Temperatura (925 hPa)/era5_temp_clim_may.nc')
...
clim_period = da.sel(valid_time=slice('1991-05-01', '2020-05-31')) # Sempre trocar de acordo com o mes
...
anom_desired = anom_daily.sel(valid_time='2024-05-04', pressure_level=925)
...
ax.set_title('Anomalia de temperatura 925 hPa - 04/05/2024')
