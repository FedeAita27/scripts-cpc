...
tempnetcdf = Dataset('C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Temperatura (925 hPa)/era5_temp_clim_june.nc')
tempnetcdf
...
clim_period = da.sel(valid_time=slice('1991-06-01', '2020-06-30')) # Sempre trocar de acordo com o mes
...
anom_desired = anom_daily.sel(valid_time='2020-06-30', pressure_level=925)
