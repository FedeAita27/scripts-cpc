...
tempnetcdf = Dataset('C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Temperatura (925 hPa)/era5_temp_clim_february.nc')
tempnetcdf
...
clim_period = da.sel(valid_time=slice('1991-02-01', '2020-02-29')) # Sempre trocar de acordo com o mes
...
anom_desired = anom_daily.sel(valid_time='2024-02-12', pressure_level=925)
...
ax.set_title('Anomalia de temperatura 925 hPa - 12/02/2024 (1991-2020)')
