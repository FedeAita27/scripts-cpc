...
tempnetcdf = Dataset('C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Anomalias_diarias/Temperatura (925 hPa)/era5_temp_clim_january.nc')
tempnetcdf
...
clim_period = da.sel(valid_time=slice('1991-01-01', '2020-01-31')) # Sempre trocar de acordo com o mes
...
anom_desired = anom_daily.sel(valid_time='2024-01-16', pressure_level=925)
...
#ax.add_feature(reg)
#ax.set_title('Anomalia de temperatura 925 hPa - 16/01/2024')
