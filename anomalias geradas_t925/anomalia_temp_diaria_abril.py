...
tempnetcdf = Dataset('C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Anomalias/Temperatura (925 hPa)/era5_temp_clim_april.nc')
tempnetcdf
...
clim_period = da.sel(valid_time=slice('1991-04-01', '2020-04-30')) # Sempre trocar de acordo com o mes
...
anom_desired = anom_daily.sel(valid_time='2024-04-30', pressure_level=925)

lon = anom_desired.longitude
lat = anom_desired.latitude

magnitude_levels = np.linspace(-6, 6, 13)

#temp_magnitude = anom_desired > 

fig, ax = plt.subplots(1, 1, figsize = (10, 8), subplot_kw={'projection': ccrs.Orthographic(-50,-60)})

ax.add_feature(cfeature.BORDERS, linestyle='-', linewidth=1)
ax.add_feature(cfeature.COASTLINE, linewidth=1)
ax.set_title('Anomalia de temperatura 925 hPa 30/04/2024')

temp_contour = ax.contourf(lon ,lat, anom_desired, cmap='RdYlBu_r',
...
# Barra de cores
colorbar_ticks = np.linspace(-6,6,7)
