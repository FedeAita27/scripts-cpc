...
tempnetcdf = Dataset('C:/Users/Bolsista/Desktop/Federico/IC_CHICO/ERA5/Temperatura (925 hPa)/era5_temp_clim_july.nc')
tempnetcdf
...
clim_period = da.sel(valid_time=slice('1991-07-01', '2020-07-31')) # Sempre trocar de acordo com o mes
...
anom_desired = anom_daily.sel(valid_time='2020-07-06', pressure_level=925)
